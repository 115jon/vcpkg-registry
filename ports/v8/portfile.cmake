...
set(OPTIONS
    -DV8_ENABLE_I18N=OFF
    -DV8_BUILD_SHARED=${V8_BUILD_SHARED}
    -DV8_MONOLITHIC=${V8_MONOLITHIC}
    -DV8_BUILD_SAMPLES=OFF
)
...
# Suppress warnings-as-errors on non-Windows (V8 has many warnings)
# Use lld linker to avoid GNU ld memory exhaustion on large builds
if(NOT VCPKG_TARGET_IS_WINDOWS)
    set(VCPKG_CXX_FLAGS "${VCPKG_CXX_FLAGS} -Wno-error")
    set(VCPKG_C_FLAGS "${VCPKG_C_FLAGS} -Wno-error")
    # Use lld via -B to specify linker search path - much more memory-efficient than GNU ld
